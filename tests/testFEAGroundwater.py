...
class TestFEAGroundwater(unittest.TestCase):
    ...
    def testFEAGroundwaterProperty(self):
        ...
        hydraulic.FEAGroundwater.setK1Surface(21655)
        hydraulic.FEAGroundwater.setMvModel(MVModel.MV_FLUID)
        hydraulic.FEAGroundwater.setMv(86.7)
        self.model.save()
        self.model.close()
        self.model = self.modeler.openFile(self.copiedModelPath)
        self.material = self.model.getAllMaterialProperties()[0]
        ...
        self.assertEqual(hydraulic.FEAGroundwater.getK1Surface(), 21655)
        self.assertEqual(hydraulic.FEAGroundwater.getMvModel(), MVModel.MV_FLUID)
        self.assertEqual(hydraulic.FEAGroundwater.getMv(), 86.7)
