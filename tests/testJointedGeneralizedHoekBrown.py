...
class TestJointedGeneralizedHoekBrown(unittest.TestCase):
    ...
    def testJointedGeneralizedHoekBrownProperty(self):
        ...
        strength.JointedGeneralizedHoekBrown.setTensileCutoffType(TensileCutoffOptions.TENSILE_CUTOFF_HOEK_MARTIN)
        ...
        self.assertEqual(strength.JointedGeneralizedHoekBrown.getTensileCutoffType(), TensileCutoffOptions.TENSILE_CUTOFF_HOEK_MARTIN)
