...
class TestInitialConditions(unittest.TestCase):
    ...
    def testInitialConditionsProperty(self):
        ...
        material.InitialConditions.setInitialPiezoToUse(31597)
        material.InitialConditions.setInitialHuType(HuTypes.HT_AUTO)
        material.InitialConditions.setInitialHu(1413.6)
        material.InitialConditions.setIntiialGridToUse(24337)
        material.InitialConditions.setInitialTemperatureCondition(StaticWaterModes.SWM_PWP)
        material.InitialConditions.setInitialTemperature(2350.4)
        material.InitialConditions.setInitialTemperatureGridToUse(3023)
        self.model.save()
        self.model.close()
        self.model = self.modeler.openFile(self.copiedModelPath)
        self.material = self.model.getAllMaterialProperties()[0]
        ...
        self.assertEqual(material.InitialConditions.getInitialPiezoToUse(), 31597)
        self.assertEqual(material.InitialConditions.getInitialHuType(), HuTypes.HT_AUTO)
        self.assertEqual(material.InitialConditions.getInitialHu(), 1413.6)
        self.assertEqual(material.InitialConditions.getIntiialGridToUse(), 24337)
        self.assertEqual(material.InitialConditions.getInitialTemperatureCondition(), StaticWaterModes.SWM_PWP)
        self.assertEqual(material.InitialConditions.getInitialTemperature(), 2350.4)
        self.assertEqual(material.InitialConditions.getInitialTemperatureGridToUse(), 3023)
