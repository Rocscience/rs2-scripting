...
class TestPlainStrandCable(unittest.TestCase):
    ...
    def testPlainStrandCableProperty(self):
        ...
        bolt.PlainStrandCable.setBoreholeDiameter(3083)
        bolt.PlainStrandCable.setCableDiameter(5)
        bolt.PlainStrandCable.setCableModulusE(2248)
        bolt.PlainStrandCable.setCablePeak(2060)
        bolt.PlainStrandCable.setOutofPlaneSpacing(3270)
        bolt.PlainStrandCable.setWaterCementRatio(1345)
        bolt.PlainStrandCable.setJointShear(0)
        bolt.PlainStrandCable.setFacePlates(0)
        bolt.PlainStrandCable.setAddPullOutForce(0)
        bolt.PlainStrandCable.setPullOutForce(355)
        bolt.PlainStrandCable.setConstantShearStiffness(1)
        bolt.PlainStrandCable.setStiffness(2861)
        ...
        self.bolt = self.model.getAllBoltProperties()[0]
        bolt = self.bolt
        self.assertEqual(bolt.PlainStrandCable.getBoreholeDiameter(), 3083)
        self.assertEqual(bolt.PlainStrandCable.getCableDiameter(), 5)
        self.assertEqual(bolt.PlainStrandCable.getCableModulusE(), 2248)
        self.assertEqual(bolt.PlainStrandCable.getCablePeak(), 2060)
        self.assertEqual(bolt.PlainStrandCable.getOutofPlaneSpacing(), 3270)
        self.assertEqual(bolt.PlainStrandCable.getWaterCementRatio(), 1345)
        ...
        self.assertEqual(bolt.PlainStrandCable.getPullOutForce(), 355)
        self.assertEqual(bolt.PlainStrandCable.getConstantShearStiffness(), 1)
        self.assertEqual(bolt.PlainStrandCable.getStiffness(), 2861)
