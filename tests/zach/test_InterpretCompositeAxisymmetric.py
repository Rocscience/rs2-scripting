...
# vanila untouched
base_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\BaseModel_InterpretCompositeAxisymmetric.fez'
#unit test result
final_python_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Interpret\interpretCompositeAxisymmetric_python.fez'
# CSV to write data
csvFile = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Interpret\interpretCompositeAxisymmetric.csv'
...
def test1():
    ...
    assert(extractJointElementResults(compJointStage2.joint_element_results)[0][6] != extractJointElementResults(compJointStage3.joint_element_results)[0][6]) # Assert shear stress change in joint
