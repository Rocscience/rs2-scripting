...
final_ui_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Material\hydraulicTransientBrooksCorey_ui.fez'
#unit test result
final_python_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Material\hydraulicTransientBrooksCorey_python.fez'
...
def test1():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_BROOK)
    ...
    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_BROOK)
...
def test3():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_BROOK)
    mat.Hydraulic.FEAGroundwater.Brooks.setKs(1.1)
    ...
    mat.Hydraulic.FEAGroundwater.Brooks.setWCInputType(WCInputType.WC_INPUT_WC)
    mat.Hydraulic.FEAGroundwater.Brooks.setWCSat(0.4)
    mat.Hydraulic.FEAGroundwater.Brooks.setWCRes(0.5)
    mat.Hydraulic.FEAGroundwater.setMvModel(MVModel.MV_CONSTANT)
    mat.Hydraulic.FEAGroundwater.setMv(1.6)

    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_BROOK)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getKs(), 1.1)
    ...
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getWCInputType(), WCInputType.WC_INPUT_WC)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getWCSat(), 0.4)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getWCRes(), 0.5)
...
def test6():
    ...
    mat.Hydraulic.FEAGroundwater.setK1Definition(AnisotropyDefinitions.ANISOTROPY_DEFINITION_ANGLE)
    mat.Hydraulic.FEAGroundwater.setK1Angle(1.3)
    mat.Hydraulic.FEAGroundwater.Brooks.setWCInputType(WCInputType.WC_INPUT_DOS)
    mat.Hydraulic.FEAGroundwater.Brooks.setDoSSat(0.4)
    mat.Hydraulic.FEAGroundwater.Brooks.setDoSRes(0.5)
    mat.Hydraulic.FEAGroundwater.setMvModel(MVModel.MV_CONSTANT)
    mat.Hydraulic.FEAGroundwater.setMv(1.6)
    ...
    assert(mat.Hydraulic.FEAGroundwater.getK1Definition(), AnisotropyDefinitions.ANISOTROPY_DEFINITION_ANGLE)
    assert(mat.Hydraulic.FEAGroundwater.getK1Angle(), 1.3)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getWCInputType(), WCInputType.WC_INPUT_DOS)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getDoSSat(), 0.4)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getDoSRes(), 0.5)
    assert(mat.Hydraulic.FEAGroundwater.getMvModel(), MVModel.MV_CONSTANT)
    assert(mat.Hydraulic.FEAGroundwater.getMv(), 1.6)
...
def test11():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_BROOK)
    mat.Hydraulic.FEAGroundwater.Brooks.setPoreSizeIndex(1.1)
    mat.Hydraulic.FEAGroundwater.Brooks.setBubblingPressure(1.2)

    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_BROOK)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getPoreSizeIndex(), 1.1)
    assert(mat.Hydraulic.FEAGroundwater.Brooks.getBubblingPressure(), 1.2)
