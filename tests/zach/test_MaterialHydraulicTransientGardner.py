...
final_ui_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Material\hydraulicTransientGardner_ui.fez'
#unit test result
final_python_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Material\hydraulicTransientGardner_python.fez'
...
def test1():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_GARDNER)
    ...
    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_GARDNER)
...
def test3():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_GARDNER)
    mat.Hydraulic.FEAGroundwater.Gardner.setKs(1.1)
    ...
    mat.Hydraulic.FEAGroundwater.Gardner.setWCInputType(WCInputType.WC_INPUT_WC)
    mat.Hydraulic.FEAGroundwater.Gardner.setWCSat(0.4)
    mat.Hydraulic.FEAGroundwater.Gardner.setWCRes(0.5)
    mat.Hydraulic.FEAGroundwater.setMvModel(MVModel.MV_CONSTANT)
    mat.Hydraulic.FEAGroundwater.setMv(1.6)

    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_GARDNER)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getKs(), 1.1)
    ...
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getWCInputType(), WCInputType.WC_INPUT_WC)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getWCSat(), 0.4)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getWCRes(), 0.5)
...
def test6():
    ...
    mat.Hydraulic.FEAGroundwater.setK1Definition(AnisotropyDefinitions.ANISOTROPY_DEFINITION_ANGLE)
    mat.Hydraulic.FEAGroundwater.setK1Angle(1.3)
    mat.Hydraulic.FEAGroundwater.Gardner.setWCInputType(WCInputType.WC_INPUT_DOS)
    mat.Hydraulic.FEAGroundwater.Gardner.setDoSSat(0.4)
    mat.Hydraulic.FEAGroundwater.Gardner.setDoSRes(0.5)
    mat.Hydraulic.FEAGroundwater.setMvModel(MVModel.MV_CONSTANT)
    mat.Hydraulic.FEAGroundwater.setMv(1.6)
    ...
    assert(mat.Hydraulic.FEAGroundwater.getK1Definition(), AnisotropyDefinitions.ANISOTROPY_DEFINITION_ANGLE)
    assert(mat.Hydraulic.FEAGroundwater.getK1Angle(), 1.3)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getWCInputType(), WCInputType.WC_INPUT_DOS)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getDoSSat(), 0.4)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getDoSRes(), 0.5)
    assert(mat.Hydraulic.FEAGroundwater.getMvModel(), MVModel.MV_CONSTANT)
    assert(mat.Hydraulic.FEAGroundwater.getMv(), 1.6)
...
def test11():
    ...
    mat.Hydraulic.FEAGroundwater.setModel(GroundWaterModes.SL_WATER_MODE_GARDNER)
    mat.Hydraulic.FEAGroundwater.Gardner.setA(1.1)
    mat.Hydraulic.FEAGroundwater.Gardner.setN(1.2)

    assert(mat.Hydraulic.FEAGroundwater.getModel(), GroundWaterModes.SL_WATER_MODE_GARDNER)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getA(), 1.1)
    assert(mat.Hydraulic.FEAGroundwater.Gardner.getN(), 1.2)
