...
# vanila untouched
base_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\BaseModel_InterpretCompositeExcavatedAutoRemoveOn.fez'
#unit test result
final_python_model = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Interpret\interpretCompositeExcavatedAutoRemoveOn_python.fez'
# CSV to write data
csvFile = r'S:\Students\2024-1 Jan-Apr\Zachary\scriptingModels\Interpret\interpretCompositeExcavatedAutoRemoveOn.csv'
...
def test1():
    ...
    for stage in range(1,5):
        assert(len(allCompositeResults[stage])==0) # Assert composite does not exist for all stages
