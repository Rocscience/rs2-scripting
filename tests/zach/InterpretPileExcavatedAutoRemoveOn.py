...
def test1():
    ...
    assert(extractLinerElementResults(pile1LinerStage2.liner_element_results)[0][7] == None) # Assert pile 1 liner axial force is none at stage 2 (liner removed when excavated)
    assert(extractLinerElementResults(pile2LinerStage2.liner_element_results)[0][7] == None) # Assert pile 2 liner axial force is none at stage 2 (liner removed when excavated)
    ...
    assert(extractLinerElementResults(pile1LinerStage3.liner_element_results)[0][7] == None) # Assert pile 1 liner axial force is none at stage 3 (liner removed when excavated)
    assert(extractLinerElementResults(pile2LinerStage3.liner_element_results)[0][7] == None) # Assert pile 2 liner axial force is none at stage 3 (liner removed when excavated)
