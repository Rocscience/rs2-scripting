...
class TestTemperatureVsUnfrozenWaterContentTable(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def testUnsaturatedZoneTableSuccess(self):
        ...
        self.material.Thermal.SoilUnfrozenWaterContent.CustomWaterContent.setTemperatureVsUnfrozenWaterContentValues(newTableColA1, newTableColA2)

        result1 = self.material.Thermal.SoilUnfrozenWaterContent.CustomWaterContent.getTemperatureVsUnfrozenWaterContentValues()
    ...
    def testUnsaturatedZoneTableFailureDifferentSize(self):
        ...
        self.material.Thermal.SoilUnfrozenWaterContent.CustomWaterContent.setTemperatureVsUnfrozenWaterContentValues(validCol1, validCol2)

        invalidCol1 = [-1.11,0,1]
        invalidCol2 = [-1.22,0.2,1.3,2.4]

        with self.assertRaises(Exception):
            self.material.Thermal.SoilUnfrozenWaterContent.CustomWaterContent.setTemperatureVsUnfrozenWaterContentValues(invalidCol1, invalidCol2)
