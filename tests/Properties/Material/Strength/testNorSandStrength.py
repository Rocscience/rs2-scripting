...
class TestNorSandStrength(unittest.TestCase):
    ...
    def testNorSandStrengthProperty(self):
        ...
        strength.NorSandStrength.setInitialConsolidationCondition(NorSandInitialConsolidationCondition.NORSAND_INITIAL_MEAN_STRESS)
        ...
        self.assertEqual(strength.NorSandStrength.getInitialConsolidationCondition(), NorSandInitialConsolidationCondition.NORSAND_INITIAL_MEAN_STRESS)
