...
class TestHardeningSoilWithSmallStrainStiffness(unittest.TestCase):
    ...
    def testHardeningSoilWithSmallStrainStiffnessProperty(self):
        ...
        strength.HardeningSoilWithSmallStrainStiffness.setInitialConsolidationCondition(InitialConsolidation.INITIAL_MEAN_STRESS)
        ...
        self.assertEqual(strength.HardeningSoilWithSmallStrainStiffness.getInitialConsolidationCondition(), InitialConsolidation.INITIAL_MEAN_STRESS)
