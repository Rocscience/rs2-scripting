...
class TestSoftSoilStrength(unittest.TestCase):
    ...
    def testSoftSoilStrengthProperty(self):
        ...
        strength.SoftSoilStrength.setInitialConsolidationCondition(InitialConsolidation.CONSOL_INITIAL_MEAN_STRESS)
        ...
        self.assertEqual(strength.SoftSoilStrength.getInitialConsolidationCondition(), InitialConsolidation.CONSOL_INITIAL_MEAN_STRESS)
