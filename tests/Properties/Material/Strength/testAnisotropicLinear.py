...
class TestAnisotropicLinear(unittest.TestCase):
    ...
    def testAnisotropicLinearProperty(self):
        ...
        strength.AnisotropicLinear.setAnisotropyDefinition(AnisotropyDefinitions.ANGLE)
        ...
        self.assertEqual(strength.AnisotropicLinear.getAnisotropyDefinition(), AnisotropyDefinitions.ANGLE)
