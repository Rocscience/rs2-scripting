...
class TestHardeningSoilStrength(unittest.TestCase):
    ...
    def testHardeningSoilStrengthProperty(self):
        ...
        strength.HardeningSoilStrength.setInitialConsolidationCondition(InitialConsolidation.INITIAL_MEAN_STRESS)
        ...
        self.assertEqual(strength.HardeningSoilStrength.getInitialConsolidationCondition(), InitialConsolidation.INITIAL_MEAN_STRESS)
