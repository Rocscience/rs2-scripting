...
class TestGeneralizedHoekBrown(unittest.TestCase):
    ...
    def testGeneralizedHoekBrownProperty(self):
        ...
        strength.GeneralizedHoekBrown.setTensileCutoffType(TensileCutoffOptions.TENSILE_CUTOFF_HOEK_MARTIN)
        ...
        self.assertEqual(strength.GeneralizedHoekBrown.getTensileCutoffType(), TensileCutoffOptions.TENSILE_CUTOFF_HOEK_MARTIN)
