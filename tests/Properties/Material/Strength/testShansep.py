...
class TestShansep(unittest.TestCase):
    ...
    def testShansepProperty(self):
        ...
        strength.Shansep.setStressHistoryType(StressHistoryTypes.PRECONSOLIDATION_PRESSURE_PC)
        ...
        self.assertEqual(strength.Shansep.getStressHistoryType(), StressHistoryTypes.PRECONSOLIDATION_PRESSURE_PC)
