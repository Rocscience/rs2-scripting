...
class TestSofteningHardeningModel(unittest.TestCase):
    ...
    def testSofteningHardeningModelProperty(self):
        ...
        strength.SofteningHardeningModel.setConeHardeningType(ConeHardeningTypes.TABULAR)
        ...
        self.assertEqual(strength.SofteningHardeningModel.getConeHardeningType(), ConeHardeningTypes.TABULAR)
