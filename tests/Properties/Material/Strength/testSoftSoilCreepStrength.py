...
class TestSoftSoilCreepStrength(unittest.TestCase):
    ...
    def testSoftSoilCreepStrengthProperty(self):
        ...
        strength.SoftSoilCreepStrength.setInitialConsolidationCondition(InitialConsolidation.CONSOL_INITIAL_MEAN_STRESS)
        ...
        self.assertEqual(strength.SoftSoilCreepStrength.getInitialConsolidationCondition(), InitialConsolidation.CONSOL_INITIAL_MEAN_STRESS)
