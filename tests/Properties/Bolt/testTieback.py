...
class TestTieback(unittest.TestCase):
    ...
    def testTiebackProperty(self):
        ...
        bolt.Tieback.setBoltModel(BoltModels.ELASTIC)
        ...
        bolt.Tieback.setSecondaryBondLengthType(SecondaryBondLengthType.LENGTH)
        ...
        self.assertEqual(bolt.Tieback.getBoltModel(), BoltModels.ELASTIC)
        ...
        self.assertEqual(bolt.Tieback.getSecondaryBondLengthType(), SecondaryBondLengthType.LENGTH)
