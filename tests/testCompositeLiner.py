...
class TestCompositeLiner(unittest.TestCase):
    ...
    def testCompositeLinerProperty(self):
        ...
        compositeliner.setJointPropertyByName("Joint 1")
        compositeliner.getLinerPropertyName(1)
        compositeliner.setLinerPropertyByName(1, "Liner 1")
        compositeliner.setNumberOfLayers(1)
        compositeliner.setJointApplied(True)
        compositeliner.getInstallDelay(2)
        compositeliner.setInstallDelay(2, 2)
        compositeliner.getRemovedStage(1)
        ...
        self.assertEqual(compositeliner.getNumberOfLayers(), 1)
