...
class TestGeosynthetic(unittest.TestCase):
    ...
    def testGeosyntheticProperty(self):
        ...
        liner.Geosynthetic.setInitialTemperature(1692.5)
        liner.Geosynthetic.setTensileModulus(2236.1)
        liner.Geosynthetic.setMaterialType(MaterialType.PLASTIC)
        liner.Geosynthetic.setTensileStrengthPeak(2451.5)
        liner.Geosynthetic.setTensileStrengthResidual(1416.1)
        liner.Geosynthetic.setActivateThermal(1)
        liner.Geosynthetic.setStaticTemperatureMode(StaticWaterModes.SWM_GRID)
        liner.Geosynthetic.setStaticTemperature(1333.7)
        liner.Geosynthetic.setConductivity(1837.3)
        liner.Geosynthetic.setSpecificHeatCapacity(94.3)
        liner.Geosynthetic.setThermalExpansion(1)
        liner.Geosynthetic.setExpansionCoefficient(3117.2)
        ...
        self.liner = self.model.getAllLinerProperties()[0]
        liner = self.liner
        self.assertEqual(liner.Geosynthetic.getInitialTemperature(), 1692.5)
        self.assertEqual(liner.Geosynthetic.getTensileModulus(), 2236.1)
        self.assertEqual(liner.Geosynthetic.getMaterialType(), MaterialType.PLASTIC)
        self.assertEqual(liner.Geosynthetic.getTensileStrengthPeak(), 2451.5)
        self.assertEqual(liner.Geosynthetic.getTensileStrengthResidual(), 1416.1)
        ...
        self.assertEqual(liner.Geosynthetic.getStaticTemperature(), 1333.7)
        self.assertEqual(liner.Geosynthetic.getConductivity(), 1837.3)
        self.assertEqual(liner.Geosynthetic.getSpecificHeatCapacity(), 94.3)
        self.assertEqual(liner.Geosynthetic.getThermalExpansion(), 1)
        self.assertEqual(liner.Geosynthetic.getExpansionCoefficient(), 3117.2)
