...
class TestGeosynthetic(unittest.TestCase):
    ...
    def testGeosyntheticProperty(self):
        ...
        liner.Geosynthetic.setInitialTemperature(3008)
        liner.Geosynthetic.setTensileModulus(751)
        liner.Geosynthetic.setMaterialType(MaterialType.PLASTIC)
        liner.Geosynthetic.setTensileStrengthPeak(606)
        liner.Geosynthetic.setTensileStrengthResidual(480)
        liner.Geosynthetic.setActivateThermal(0)
        liner.Geosynthetic.setStaticTemperatureMode(StaticWaterModes.SWM_GRID)
        liner.Geosynthetic.setStaticTemperature(749)
        liner.Geosynthetic.setConductivity(747)
        liner.Geosynthetic.setSpecificHeatCapacity(1215)
        liner.Geosynthetic.setThermalExpansion(0)
        liner.Geosynthetic.setExpansionCoefficient(876)
        ...
        self.liner = self.model.getAllLinerProperties()[0]
        liner = self.liner
        self.assertEqual(liner.Geosynthetic.getInitialTemperature(), 3008)
        self.assertEqual(liner.Geosynthetic.getTensileModulus(), 751)
        self.assertEqual(liner.Geosynthetic.getMaterialType(), MaterialType.PLASTIC)
        self.assertEqual(liner.Geosynthetic.getTensileStrengthPeak(), 606)
        self.assertEqual(liner.Geosynthetic.getTensileStrengthResidual(), 480)
        ...
        self.assertEqual(liner.Geosynthetic.getStaticTemperature(), 749)
        self.assertEqual(liner.Geosynthetic.getConductivity(), 747)
        self.assertEqual(liner.Geosynthetic.getSpecificHeatCapacity(), 1215)
        self.assertEqual(liner.Geosynthetic.getThermalExpansion(), 0)
        self.assertEqual(liner.Geosynthetic.getExpansionCoefficient(), 876)
