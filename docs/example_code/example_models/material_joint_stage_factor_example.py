...
newStageFactor = jointmaterial.BartonBandisMaterial.stageFactorInterface.createStageFactor(1)
jointmaterial.BartonBandisMaterial.stageFactorInterface.setDefinedStageFactors({ 1: newStageFactor })
...
newStageFactor = jointmaterial.GeosyntheticHyperbolicMaterial.stageFactorInterface.createStageFactor(1)
jointmaterial.GeosyntheticHyperbolicMaterial.stageFactorInterface.setDefinedStageFactors({ 1: newStageFactor })
