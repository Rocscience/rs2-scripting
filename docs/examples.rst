...
.. _Liner Example:
.. literalinclude:: example_code/liner_prop_example.py
   :language: python
...
.. _material property strength example:
.. literalinclude:: example_code/material_property_strength_example.py
   :language: python
   :caption: Code Snippet: Manipulation of Strength Properties
...
.. _Modeler Example:
.. literalinclude:: example_code/modeler_example.py
   :language: python
