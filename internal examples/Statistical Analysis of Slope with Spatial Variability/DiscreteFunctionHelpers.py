...
class DiscreteFunctionHelpers:
    ...
    def importDiscreteFunctionFilesToRS2(modeler: RS2Modeler, base_file_path: str,
        ...
        output_dir: str, compute_models=False):
        """
        Generate sample models for each found discrete function variation and update the RS2 modeler with this data.

        Args:
            modeler (RS2Modeler): The RS2 modeler instance used to open and manipulate models.
            base_file_path (str): The file path of the base model to be used as a template.
            discrete_function_file_paths (list[str]): A list of file paths containing discrete function data.
            output_dir (str): The directory where the updated model files will be saved.
            compute_models (bool, optional): True to compute the models after updating. Default is False.
