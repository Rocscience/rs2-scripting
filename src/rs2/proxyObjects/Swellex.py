...
class Swellex(PropertyProxy):
	...
	def setProperties(self, BoltModulusE : float = None, TensileCapacity : float = None, ResidualTensileCapacity : float = None, TributaryArea : float = None, BondStrength : float = None, ResidualBondStrength : float = None, BondShearStiffness : float = None, OutofPlaneSpacing : float = None, FacePlates : bool = None, PreTensioningForce : float = None, ConstantPretensioningForceInInstallStage : bool = None, BoltModel : BoltModels = None, JointShear : bool = None, AddPullOutForce : bool = None, PullOutForce : float = None, MaterialDependent : bool = None, BondStrengthCoefficient : float = None, BondShearStiffnessCoefficient : float = None):
