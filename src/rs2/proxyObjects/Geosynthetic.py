...
class Geosynthetic(PropertyProxy):
	...
	def setProperties(self, TensileModulus : float = None, MaterialType : MaterialType = None, TensileStrengthPeak : float = None, TensileStrengthResidual : float = None, StageGeosyntheticProperties : bool = None, ActivateThermal : bool = None, Conductivity : float = None, SpecificHeatCapacity : float = None, ThermalExpansion : bool = None, ExpansionCoefficient : float = None, InitialTemperature : float = None, StaticTemperatureMode : StaticWaterModes = None, StaticTemperature : float = None):
