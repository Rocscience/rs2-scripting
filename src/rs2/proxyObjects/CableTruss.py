...
class CableTruss(PropertyProxy):
	...
	def setProperties(self, YoungsModulus : float = None, MaterialType : MaterialType = None, TensileStrengthPeak : float = None, TensileStrengthResidual : float = None, PreTensioning : bool = None, PreTensioningForce : float = None, CableDiameter : float = None, OutofplaneSpacing : float = None, StageCableProperties : bool = None, ActivateThermal : bool = None, Conductivity : float = None, SpecificHeatCapacity : float = None, ThermalExpansion : bool = None, ExpansionCoefficient : float = None, StaticTemperatureMode : StaticWaterModes = None, StaticTemperature : float = None):
