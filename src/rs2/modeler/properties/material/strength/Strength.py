...
class Strength(PropertyProxy):
	...
	def __init__(self, client : Client, ID, documentProxyID, stageFactorInterfaceID):
		...
		self.BoundingSurfacePlasticity = BoundingSurfacePlasticity(client, ID, documentProxyID, stageFactorInterfaceID)
		...
		self.Finn = Finn(client, ID, documentProxyID, stageFactorInterfaceID)
		self.BartonBandisStrength = BartonBandisStrength(client, ID, documentProxyID)
		self.Hyperbolic = Hyperbolic(client, ID, documentProxyID, stageFactorInterfaceID)
		...
		self.Shansep = Shansep(client, ID, documentProxyID, stageFactorInterfaceID)
		self.VerticalStressRatio = VerticalStressRatio(client, ID, documentProxyID, stageFactorInterfaceID)
		self.SnowdenModAnisotropicLinear = SnowdenModAnisotropicLinear(client, ID, documentProxyID)
		self.AnisotropicLinear = AnisotropicLinear(client, ID, documentProxyID, stageFactorInterfaceID)
