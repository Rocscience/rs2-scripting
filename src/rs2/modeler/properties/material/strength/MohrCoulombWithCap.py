...
class MohrCoulombWithCap(PropertyProxy):
	def __init__(self, client : Client, ID, documentProxyID, stageFactorInterfaceID):
		...
		self.stageFactorInterface = AbsoluteStageFactorInterface[MohrCoulombWithCapDefinedStageFactor, MohrCoulombWithCapStageFactor](self._client, stageFactorInterfaceID, ID, MohrCoulombWithCapDefinedStageFactor, MohrCoulombWithCapStageFactor)
