...
class HydraulicVariableTypes(Enum):
	KS = "MP_DISTRIBUTION_KS_FUNCTION"
	K2K1 = "MP_DISTRIBUTION_K2_K1_FUNCTION"
	# K1_DEFINITION = "K1_DEFINITION"
	K1_ANGLE = "MP_DISTRIBUTION_K1_ANGLE_FUNCTION"
	# WC_INPUT_TYPE = "WC_INPUT_TYPE"
	WC_SAT = "MP_DISTRIBUTION_WC_FUNCTION"
	WC_RES = "MP_DISTRIBUTION_WC_RES_FUNCTION"
	DOS_SAT = "MP_DISTRIBUTION_DOS_FUNCTION"
	DOS_RES = "MP_DISTRIBUTION_DOS_RES_FUNCTION"
