...
class HydraulicDistributionTypes(Enum):
	CONSTANT_DIST = "CONSTANT_DIST"
	MEAN_STRESS_DIST = "MEAN_STRESS_DIST"
	VERTICAL_STRESS_DIST = "VERTICAL_DIST"
	HORIZONTAL_STRESS_DIST = "HORIZONTAL_STRESS_DIST"
	VOLUMETRIC_STRAIN_DIST = "VOLUMETRIC_STRAIN_DIST"
	COORDINATE_DIST = "COORDINATE_DIST"
