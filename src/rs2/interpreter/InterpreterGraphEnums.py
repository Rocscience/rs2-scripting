...
class HistoryQueryGraphEnums():
    ...
    class VerticalAxisTypes(Enum):
        """
        Set the vertical axis type of the history query graph.
        ...
        | PORE_PRESSURE                                       |
        +-----------------------------------------------------+
        | HORIZONTAL_HYDRAULIC_VELOCITY                       |
        +-----------------------------------------------------+
        | VERTICAL_HYDRAULIC_VELOCITY                         |
        +-----------------------------------------------------+
        | HORIZONTAL_HYDRAULIC_GRADIENT                       |
        +-----------------------------------------------------+
        | VERTICAL_HYDRAULIC_GRADIENT                         |
        +-----------------------------------------------------+
        +-----------------------------------------------------+
        | TEMPERATURE                                         |
        +-----------------------------------------------------+
        | HORIZONTAL_THERMAL_FLUX                             |
        +-----------------------------------------------------+
        | VERTICAL_THERMAL_FLUX                               |
        +-----------------------------------------------------+
        | HORIZONTAL_THERMAL_GRADIENT                         |
        +-----------------------------------------------------+
        | VERTICAL_THERMAL_GRADIENT                           |
        +-----------------------------------------------------+
    ...
    class HorizontalAxisTypes(Enum):
        """
        Set the horizontal axis type of the history query graph.
...
class TimeQueryGraphEnums():
    ...
    class VerticalAxisTypes(Enum):
        """
        Set the vertical axis type of the time query graph.
